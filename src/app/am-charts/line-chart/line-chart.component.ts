...
import am5Locales_el_GR from "@amcharts/amcharts5/locales/el_GR";
...
export class LineChartComponent implements OnInit, OnDestroy, AfterViewInit {
  ...
  ngAfterViewInit() {
    this.zone.runOutsideAngular(() => {
      ...
      this.root.locale = am5Locales_el_GR;
...
// https://www.amcharts.com/docs/v5/charts/xy-chart/axes/
      ...
      // console.log(xAxis.get('dateFormats'));
      // xAxis.get('dateFormats')['day'] = 'MMM';
      // xAxis.get('dateFormats')['year'] = 'MMM';
      // xAxis.get("periodChangeDateFormats")["day"] = "MMM";
      // xAxis.get("periodChangeDateFormats")["year"] = "MMM";
...
//       let series = chart.series.push(am5xy.LineSeries.new(this.root, {
      let series = chart.series.push(am5xy.SmoothedXLineSeries.new(this.root, {
        ...
        valueYField: 'value',
        valueXField: 'date',
        stroke: am5.color(0xffc727),
        fill: am5.color(0xffc727),
        tooltip: am5.Tooltip.new(this.root, {
          pointerOrientation: 'horizontal',
          labelText: '{valueY}'
        })
      }));
      // series.set('fill', am5.color(0xffc727))
